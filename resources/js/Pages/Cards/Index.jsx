        ...
        <div className="relative z-10 h-full flex flex-col justify-between">
            <div className="flex justify-between items-start">
                <div className="space-y-1">
                    <p className="text-[10px] font-black text-white/50 uppercase tracking-widest">Available Balance</p>
            ...
            <div className="space-y-4">
                ...
                <div className="flex justify-between items-end">
                    <div>
                        <p className="text-[8px] font-black text-white/50 uppercase tracking-widest mb-1">Card Holder</p>
                        <p className="text-xs font-bold uppercase">{card.holder_name || 'JOHN DOE'}</p>
                    </div>
                    <div className="text-right">
                        <p className="text-[8px] font-black text-white/50 uppercase tracking-widest mb-1">Expires</p>
            ...
            <div className="space-y-8 mt-8">
                ...
                <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
                    <div>
                        ...
                        <p className="text-sm text-gray-500 mt-1">Total combined balance: <span className="text-black font-black">${totalCardBalance.toLocaleString()}</span></p>
                    </div>
                    <Link 
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        ...
                        <div className="bg-[#FAF9F6] p-10 rounded-[40px] border border-gray-100">
                            <h3 className="text-xl font-black text-gray-900 mb-6 flex items-center gap-3">
                                <Crown className="w-6 h-6 text-yellow-500" /> Exclusive Benefits
                            </h3>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div className="flex gap-4">
                                    ...
                                    <div>
                                        <h4 className="font-bold text-sm text-gray-900">Purchase Protection</h4>
                                        <p className="text-xs text-gray-400 mt-1 leading-relaxed">Your physical cards are covered by HarborBank's advanced fraud protection and zero-liability policy.</p>
                                    </div>
                                </div>
                                <div className="flex gap-4">
                                    <div className="w-12 h-12 rounded-2xl bg-white flex items-center justify-center shadow-sm flex-shrink-0">
                                    ...
                                    <div>
                                        <h4 className="font-bold text-sm text-gray-900">Cashback Rewards</h4>
                                        <p className="text-xs text-gray-400 mt-1 leading-relaxed">Earn up to 3% cashback on all international transactions and online e-shopping purchases.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="bg-black p-8 rounded-[40px] text-white overflow-hidden relative group">
                            ...
                            <h3 className="text-lg font-black mb-2 relative z-10">Card Analytics</h3>
                            <p className="text-xs text-gray-400 mb-8 relative z-10">Spending distribution by card type.</p>
