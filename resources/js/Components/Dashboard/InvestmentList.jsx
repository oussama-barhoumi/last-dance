    ...
    <div className="flex items-center justify-between p-6 bg-white rounded-3xl border border-gray-50 hover:border-purple-100 transition-all group">
        ...
        <div className="flex items-center gap-16">
            <div className="text-right">
                ...
                <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mt-0.5">Investment Value</p>
            </div>
            <div className="text-right min-w-[80px]">
                <p className={`font-black ${isNegative ? 'text-red-500' : 'text-green-500'}`}>
                    {isNegative ? '-' : '+'}{Math.abs(returnValue)}%
                </p>
                <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mt-0.5">Return Value</p>
            </div>
        </div>
    </div>
);
    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between mb-2">
                <h3 className="text-2xl font-black text-gray-900">My Investment</h3>
            </div>
