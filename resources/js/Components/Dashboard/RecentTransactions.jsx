...
const categories = [
    { id: 'online', name: 'Online', icon: Laptop },
...
const transactionData = {
    online: [
        { icon: ShoppingBag, title: "Amazon Prime", category: "Subscription", amount: 14.99, color: "bg-blue-500", isNegative: true, date: "Today" },
    ...
    card: [
        { icon: Coffee, title: "Starbucks Coffee", category: "Food & Drink", amount: 5.50, color: "bg-orange-500", isNegative: true, date: "Today" },
        { icon: ShoppingBag, title: "Zara Fashion", category: "Shopping", amount: 89.90, color: "bg-pink-500", isNegative: true, date: "Today" },
